...
token = "NzQ0NDU3MDM5NTU1NzIzMzE0.XzjfpQ.gJ7onF4hkRf33W0WlNLfIs2dbk4"  # I've opted to just save my token to a text file. 

client = commands.Bot(command_prefix = 'o.')  # starts the discord client.
